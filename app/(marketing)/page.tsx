...
export default async function HomePage() {
  ...
  return (
    <main id="main-content" className="flex flex-1 flex-col">
      ...
      <section id="apply" className="border-t border-border bg-muted/50 px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <Card className="mt-8 rounded-xl border-border/80 p-6 shadow-lg sm:p-10">
